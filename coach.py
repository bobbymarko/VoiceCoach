...
print(f”  ElevenLabs  : {‘✓’ if ELEVENLABS_KEY else ‘✗ missing (print only)’}”)
...
time.sleep(3)
speech_queue.put("Zwift AI Coach is online. I'm watching. Let's GOOO!")
